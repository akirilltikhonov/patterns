...
public class CompressionDataSource implements DataSource {
    ...
    public CompressionDataSource(DataSource encryptionDataSource) {
    ...
    public void writeData(String data) {
        encryptionDataSource.writeData(compress(data));
    }

    @Override
    public String readData() {
        return decompress(encryptionDataSource.readData());
    }
